...
img: assets/img/cocolit-placeholder.gif
importance: 2
category: research
---
...
{% include figure.liquid path="assets/img/cocolit-placeholder.gif" title="CoCoLIT placeholder visualization" class="img-fluid rounded z-depth-1" %}
